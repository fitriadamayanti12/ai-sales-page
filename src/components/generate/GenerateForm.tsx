...
import { Sparkles, ArrowRight, Loader2, Wand2, Target, Type, Tag, DollarSign, Star } from "lucide-react"
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <label className="font-bold text-slate-900 dark:text-white">Product Name *</label>
          </div>
          <input
            type="text"
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <label className="font-bold text-slate-900 dark:text-white">Key Features</label>
            </div>
            <textarea
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <label className="font-bold text-slate-900 dark:text-white">Target Audience</label>
            </div>
            <input
              type="text"
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <label className="font-bold text-slate-900 dark:text-white">Price</label>
            </div>
            <input
              type="text"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <label className="font-bold text-slate-900 dark:text-white">Unique Selling Points</label>
            </div>
            <input
              type="text"
        ...
        {/* Template Selection */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg shadow-slate-200/80 dark:shadow-black/20 border border-slate-200 dark:border-gray-800">
          <label className="font-bold text-slate-900 dark:text-white mb-4 block">Choose Template</label>
          <div className="grid grid-cols-3 gap-4">
            {[
              { value: "modern", label: "Modern Glass", gradient: "from-blue-400 to-purple-500" },
              { value: "luxury", label: "Dark Luxury", gradient: "from-yellow-500 to-amber-700" },
              { value: "minimal", label: "Minimalist", gradient: "from-slate-400 to-slate-600" },
            ].map((tpl) => (
              <button
                key={tpl.value}
                type="button"
                onClick={() => setFormData({ ...formData, template: tpl.value })}
              ...
              >
                ...
                />
                <span className="text-sm font-bold text-slate-700 dark:text-gray-300">{tpl.label}</span>
              </button>
            ))}
          </div>
        </div>
